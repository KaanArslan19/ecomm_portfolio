...
export default function SearchFilter({ children }: Props) {
  ...
  return (
    ...
    >
      <div className="md:border-r md:border-b-0 border-b-2 border-gray-700 border-opacity-40 p-4 md:space-y-4 md:block flex space-x-8 md:space-x-0 sticky top-0 md:h-screen bg-white z-10">
        <div>
